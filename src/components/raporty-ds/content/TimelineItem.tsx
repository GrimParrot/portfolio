...
export function TimelineItem({ number, children, style }: TimelineItemProps) {
  return (
    <li style={{ listStyle: "none", display: "flex", flexDirection: "row", gap: 24, alignItems: "center", ...style }}>
      <span style={{ flexShrink: 0, minWidth: 28, alignSelf: "stretch", borderRadius: 14, background: "var(--pf-surface-accent)",
