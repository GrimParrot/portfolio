...
export function MetaBar({ items = [], style }: MetaBarProps) {
  return (
    <div className="pf-meta-bar" style={{ width: "100%", borderRadius: 16, boxShadow: "var(--pf-ring)", overflow: "hidden", ...style }}>
      {items.map((it, i) => (
        <div key={i} style={{ border: "1px solid var(--pf-border)", boxSizing: "border-box",
