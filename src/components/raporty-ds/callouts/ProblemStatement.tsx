...
export function ProblemStatement({ label = "PROBLEM STATEMENT", children, style }: ProblemStatementProps) {
  return (
    <div style={{ position: "relative", overflow: "hidden", borderRadius: 24, background: "var(--pf-surface-accent)", width: "100%", boxSizing: "border-box", ...style }}>
      ...
      <div style={{ position: "relative", display: "flex", flexDirection: "column", gap: 24, padding: 64, alignItems: "center", boxSizing: "border-box" }}>
        ...
        <p style={{ margin: 0, textAlign: "center", fontFamily: "var(--pf-font-body)", fontWeight: 700, fontSize: 22, lineHeight: "34px", color: "var(--pf-text-accent-deep)" }}>{children}</p>
      </div>
    </div>
  )
}
