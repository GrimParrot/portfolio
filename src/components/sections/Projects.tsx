...
function ProjectTile({
  ...
  return (
    ...
    <div
      ...
      className="specular-edge group flex h-full cursor-pointer flex-col gap-4 rounded-3xl border border-pf-line bg-white p-3.5 shadow-[0_1px_2px_rgba(0,0,0,0.04)] transition-transform duration-[400ms] ease-[cubic-bezier(.22,1,.36,1)] hover:-translate-y-1 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
    >
