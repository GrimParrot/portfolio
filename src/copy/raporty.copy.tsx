...
export const copy = {
  ...
  en: {
    ...
    intro: "Specialists lost hours manually assembling reports from data scattered across several tools, and the end result still needed a phone call to explain what the numbers actually meant. The new feature automatically generates and sends reports on profile activity — ranking changes, published posts, added photos, competitors overtaken. Today it's an automation trusted by 60% of the feature's users, who hand it full control over sending reports to clients.",
    introProduct: "",
    introSuffix: "",
    roleLabel: "Role",
    ...
    s01: {
      ...
      body: <>SEO specialists needed a simple, flexible reporting tool that would enable <strong style={{ color: "#0F172A" }}>clear, personalised and contextual presentation of results</strong> <strong style={{ color: "#0F172A" }}>to non-technical clients.</strong> Reports had to allow easy data selection, comparing them over time, avoiding misunderstandings from misinterpretation, and offer <strong style={{ color: "#0F172A" }}>automatic sending</strong> — reducing the number of questions and <strong style={{ color: "#0F172A" }}>strengthening trust in the collaboration.</strong></>,
      metrics: [
      ...
      quote: <>There's real interest and engagement here. Some clients <strong style={{ color: "#466AFA", fontWeight: 800 }}>pay just for this.</strong> This feature solved a real user problem, which reduced <strong style={{ color: "#466AFA", fontWeight: 800 }}>friction and churn.</strong></>,
    ...
    s02: {
      ...
      pullQuote: <>Specialists spent hours <strong style={{ color: "#466AFA", fontWeight: 800 }}>manually assembling reports</strong> — and then <strong style={{ color: "#466AFA", fontWeight: 800 }}>explaining them</strong>, something the non-technical client couldn't have read on their own anyway.</>,
