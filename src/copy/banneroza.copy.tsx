export const copy = {
  ...
  en: {
    ...
    body: <>A conceptual website project for the <strong className="text-primary-700">Szyldowe Rewolucje</strong> competition, an initiative fighting advertising chaos in public space. The competition engages designers to create aesthetic, legally compliant signage for local businesses, with winning designs realized in urban space. The project was created as part of postgraduate studies in <strong className="text-primary-700">UX design | web analytics</strong> at the Białystok University of Technology.</>,
    roleLabel: "My role",
