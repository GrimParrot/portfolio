...
export const copy = {
  pl: {
    ...
    s01: {
      ...
      lastPara: <>Funkcja zwiększyła postrzeganą wartość wyższych tierów i obniżyła <strong className="text-pf-700">churn</strong> wśród agencji z wieloma klientami. Zanotowaliśmy wzrost <strong style={{ color: "var(--pf-primary-900)", fontWeight: 800 }}>adopcji funkcji</strong> oraz pośredni wpływ na <strong className="text-pf-700">liczbę zarządzanych profili</strong>, kluczową metrykę przychodu platformy.</>,
    },
    s02: {
  ...
  en: {
    ...
    s01: {
      ...
      lastPara: <>The feature increased the perceived value of higher tiers and lowered <strong className="text-pf-700">churn</strong> among agencies with multiple clients. We saw growth in <strong style={{ color: "var(--pf-primary-900)", fontWeight: 800 }}>feature adoption</strong> and an indirect impact on <strong className="text-pf-700">growth in managed profiles</strong>, a key revenue metric for the platform.</>,
    },
    s02: {
      h2: "Key findings",
      findingTitle: "",
