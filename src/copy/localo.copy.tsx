...
export const copy = {
  pl: {
    ...
    intro: "Generowanie leadów i research widoczności istniały w Localo osobno — trudne w obsłudze, wymagające onboardingu. Sales mode dodatkowo zmuszał do pracy w zewnętrznych CRM-ach i arkuszach. Zaprojektowałam ",
    ...
    s04: {
      ...
      steps: [
        ...
        { step: "02", title: "Growth Potential", desc: "Jeden scoring zamiast metryk do analizy. Wyższy wynik = łatwiejszy klient — kalkulacja zdjęta z użytkownika.", img: "/growth potential.png", imgAlt: "Growth Potential score", reverse: true },
        { step: "03", title: "Skan widoczności z poziomu leada", desc: "Jednym kliknięciem użytkownik sprawdza widoczność firmy online. Wynik to gotowy argument sprzedażowy.", img: "/pin map.png", imgAlt: "Visibility Scan — mapa z pinami", reverse: false },
        { step: "04", title: "Zarządzanie statusem leadów", desc: "Mini-CRM wbudowany w produkt. Użytkownik nie musi wychodzić do arkusza.", img: "/status.png", imgAlt: "Status leadów i komentarze", reverse: true },
        { step: "05", title: "Pogłębiona analiza", desc: "Kolejne skany widoczności dla dodatkowych słów kluczowych — wynik, keywordy, pozycja na tle konkurencji — to gotowy materiał do rozmowy, bez przepisywania.", img: "/visibility scans.png", imgAlt: "Visibility Scans", reverse: false, fullWidthTextTop: true },
        { step: "06", title: "Onboarding", desc: "Kiedy klient mówi tak — aktywacja profilu jednym kliknięciem, bez wychodzenia z widoku. Pełna pętla: od leada do pierwszego dnia współpracy.", img: "/confirmation.png", imgAlt: "Aktywacja profilu", reverse: false, contain: true },
      ],
  ...
  en: {
    ...
    intro: "Lead generation and visibility research existed in Localo as separate tools — hard to use, requiring onboarding. Sales mode also forced work in external CRMs and spreadsheets. I designed ",
    introProduct: "Client Acquisition",
    ...
    s04: {
      ...
      steps: [
        { step: "01", title: "Leads list", desc: "The user enters a category and location, the system returns Google Business profiles with key data: no website, review count, maps link. Key decision: no empty state — results immediately, no configuration or onboarding.", img: "/modal.png", imgAlt: "Modal — lead list generation", reverse: false, fullWidth: true },
        { step: "02", title: "Growth Potential", desc: "One score instead of metrics to analyze. Higher score = easier client — calculation lifted from the user.", img: "/growth potential.png", imgAlt: "Growth Potential score", reverse: true },
        { step: "03", title: "Visibility scan from the lead", desc: "One click and the user checks the business's online visibility. The result is a ready sales argument.", img: "/pin map.png", imgAlt: "Visibility Scan — pin map", reverse: false },
        { step: "04", title: "Lead status management", desc: "Mini-CRM built into the product. The user doesn't need to go to a spreadsheet.", img: "/status.png", imgAlt: "Lead status and comments", reverse: true },
        { step: "05", title: "In-depth analysis", desc: "Additional visibility scans for more keywords — the result, keywords, and position vs. competition become ready material for a conversation, without copy-pasting.", img: "/visibility scans.png", imgAlt: "Visibility Scans", reverse: false, fullWidthTextTop: true },
        { step: "06", title: "Onboarding", desc: "When the client says yes — profile activation in one click, without leaving the view. The full loop: from lead to day one of cooperation.", img: "/confirmation.png", imgAlt: "Profile activation", reverse: false, contain: true },
      ],
