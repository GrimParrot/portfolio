...
export const copy = {
  pl: {
    ...
    s01: {
      ...
      lastPara: <>Funkcja zwiększyła postrzeganą wartość wyższych tierów i obniżyła <strong className="text-primary-700">churn</strong> wśród agencji z wieloma klientami. Zanotowaliśmy wzrost <strong style={{ color: "var(--primary-900)", fontWeight: 800 }}>adopcji funkcji</strong> oraz pośredni wpływ na <strong className="text-primary-700">liczbę zarządzanych profili</strong>, kluczową metrykę przychodu platformy.</>,
    },
    s02: {
      ...
      methods: [
        { label: "Analiza ścieżek · funnel drop-off", icon: <TrendingDown className="w-s h-s" /> },
        { label: "Dane ilościowe", icon: <BarChart2 className="w-s h-s" /> },
        { label: "Nagrania sesji (Clarity)", icon: <Video className="w-s h-s" /> },
        { label: "Wywiady z użytkownikami", icon: <Users className="w-s h-s" /> },
        { label: "Dane z supportu", icon: <Headphones className="w-s h-s" /> },
        { label: "Feedback Customer Success", icon: <Star className="w-s h-s" /> },
      ],
    },
    s03: {
  ...
  en: {
    ...
    s01: {
      ...
      lastPara: <>The feature increased the perceived value of higher tiers and lowered <strong className="text-primary-700">churn</strong> among agencies with multiple clients. We saw growth in <strong style={{ color: "var(--primary-900)", fontWeight: 800 }}>feature adoption</strong> and an indirect impact on <strong className="text-primary-700">growth in managed profiles</strong>, a key revenue metric for the platform.</>,
    },
    s02: {
      h2: "Key findings",
      findingTitle: "",
      ...
      methods: [
        { label: "Path analysis · funnel drop-off", icon: <TrendingDown className="w-s h-s" /> },
        { label: "Quantitative data", icon: <BarChart2 className="w-s h-s" /> },
        { label: "Session recordings (Clarity)", icon: <Video className="w-s h-s" /> },
        { label: "User interviews", icon: <Users className="w-s h-s" /> },
        { label: "Support data", icon: <Headphones className="w-s h-s" /> },
        { label: "Customer Success feedback", icon: <Star className="w-s h-s" /> },
      ],
    },
    s03: {
